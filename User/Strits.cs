...
namespace User
{
    ...
    class Strits
    {
        public static List<Strit> strits = new List<Strit>
            ...
            new Strit(Strit.Color.Розовый,"УЛ. СРЕТЕНКА", 140, 100, new int[6] {10,50,150,450,625,750}),
            new Strit(Strit.Color.Розовый,"РОСТОВСКАЯ НАБЕРЕЖНАЯ", 160, 100, new int[6] {12,60,180,500,700,900}),
